...
public class ChangingFace extends Application {
    ...
    public void start(Stage stage) {
        ...
        // create a button that will make the face smirk
        Button smirkButton = new Button("Smirk");
        ...
        buttonBox.getChildren().addAll(smileButton, frownButton, smirkButton);
        ...
        frownButton.setOnAction(e-> {mouth.setLength(180); caption.setText("Frown");});
         ...
         // supply the code that is executed when the smirk button is pressed
        smirkButton.setOnAction(e-> {mouth.setLength(-90); caption.setText("Smirk");});
